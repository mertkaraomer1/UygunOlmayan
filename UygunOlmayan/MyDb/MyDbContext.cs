...
namespace UygunOlmayan.MyDb
{
    public class MyDbContext:DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            string connectionString = "Data Source=192.168.2.250;Initial Catalog=Muh_Plan_Prog1;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False";
